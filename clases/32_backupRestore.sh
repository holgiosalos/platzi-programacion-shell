...
restaurar_respaldo () {
    ...
    # -d \|: para establecer el delimitador para el comando cut, en este caso el delimitador sera |
    #        ya que el primer comando imprime los datos de todas las BDs en postgres separada cuyas columnas estan separadas por |
    # -f 1: para seleccionar la primera columna de la lista de BDs
    # grep -wq para verificar si el parametro bddDestino corresponde con algua de las bd listadas
